$(document).ready(function () {
    $("#wwd-design-image").click(function () {
        $("#wwd-design-image").toggle("slow", "linear").hide();
        $("#wwd-design").show();
    });
    $("#wwd-design").click(function () {
        $("#wwd-design").toggle("swing");
        $("#wwd-design-image").toggle("slow", "swing");
    })
});
...
$(document).ready(function () {
    ...
    $("#wwd-development").click(function () {
        $("#wwd-development").toggle("swing");
        $("#dev-image").toggle("slow", "swing");
    });
});
$(document).ready(function () {
    $("#mgt-image").click(function () {
        $("#mgt-image").toggle("slow", "linear").hide();
        $("#wwd-management").show();
    });
    $("#wwd-management").click(function () {
        $("#wwd-management").toggle("swing");
        $("#mgt-image").toggle("slow", "swing");
    });
});
